...
# *****************************************************************************
# Project   : HYDRA-UMC-OS-REBUILDER
# Script    : build.sh
...
printf '\n*******************************************************************************\n'
printf '%s\n' "* HYDRA-UMC-OS-REBUILDER - build.sh"
...
# Builds HYDRA-UMC-OS-REBUILDER: creates/activates a venv, installs the project
...
python -m py_compile src/hydra_umc_os_rebuilder/__init__.py src/hydra_umc_os_rebuilder/ecosystem_plan.py src/hydra_umc_os_rebuilder/firstboot_config.py src/hydra_umc_os_rebuilder/image_builder.py src/hydra_umc_os_rebuilder/main.py src/hydra_umc_os_rebuilder/qt_gui.py src/hydra_umc_os_rebuilder/i18n.py
python -c "import hydra_umc_os_rebuilder; print('import OK - version', hydra_umc_os_rebuilder.__version__)"
echo "      Done."
echo
...
echo " ==============================================================="
echo "  Build complete. Run ./run.sh to check the ecosystem's status."
echo " ==============================================================="
echo
